...
test.describe("Create_invoice_payables", () => {
  ...
  run("Create_invoice_payables", async ({ page }, testinfo) => {
    ...
    await namedStep("Step 9 - Click the Navigator img", page, testinfo, async () => {
      ...
      await createinvoicepayablespage.navigator.click();
    ...
    await namedStep("Step 11 - Click the Invoices element", page, testinfo, async () => {
      // Click the Invoices element
      await createinvoicepayablespage.invoices.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 11 - Click the Invoices element", testinfo, screenshot);
    });

    await namedStep("Step 12 - Click the element element", page, testinfo, async () => {
      // Click the element element
      await createinvoicepayablespage.createValidatePostToLedger.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 12 - Click the element element", testinfo, screenshot);
    });

    await namedStep("Step 13 - Click the Create Invoice button", page, testinfo, async () => {
      // Click the Create Invoice button
      await createinvoicepayablespage.createInvoice.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 13 - Click the Create Invoice button", testinfo, screenshot);
    });

    await namedStep("Step 14 - Click the element element", page, testinfo, async () => {
      // Click the element element
      await createinvoicepayablespage.searchBusinessUnit.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 14 - Click the element element", testinfo, screenshot);
    });

    await namedStep("Step 15 - Click the FU01 US BU01 cell", page, testinfo, async () => {
      // Click the FU01 US BU01 cell
      await createinvoicepayablespage.fu01UsBu01.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 15 - Click the FU01 US BU01 cell", testinfo, screenshot);
    });

    await namedStep("Step 16 - Enter Supplier", page, testinfo, async () => {
      // Enter Supplier
      await createinvoicepayablespage.applyData(dataRow, ["Supplier"], 0);
      // Expected: Field captures the entered data.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 16 - Enter Supplier", testinfo, screenshot);
    });

    await namedStep("Step 17 - Click the Number field", page, testinfo, async () => {
      // Click the Number field
      await createinvoicepayablespage.number.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 17 - Click the Number field", testinfo, screenshot);
    });

    await namedStep("Step 18 - Enter Number", page, testinfo, async () => {
      // Enter Number
      await createinvoicepayablespage.applyData(dataRow, ["Number"], 0);
      // Expected: Field captures the entered data.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 18 - Enter Number", testinfo, screenshot);
    });

    await namedStep("Step 19 - Click the Amount field", page, testinfo, async () => {
      // Click the Amount field
      await createinvoicepayablespage.amount.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 19 - Click the Amount field", testinfo, screenshot);
    });

    await namedStep("Step 20 - Enter Amount", page, testinfo, async () => {
      // Enter Amount
      await createinvoicepayablespage.applyData(dataRow, ["Amount"], 0);
      // Expected: Field captures the entered data.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 20 - Enter Amount", testinfo, screenshot);
    });

    await namedStep("Step 21 - Click the Expand Lines button", page, testinfo, async () => {
      // Click the Expand Lines button
      await createinvoicepayablespage.expandLines.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 21 - Click the Expand Lines button", testinfo, screenshot);
    });

    await namedStep("Step 22 - Click the Amount field", page, testinfo, async () => {
      // Click the Amount field
      await createinvoicepayablespage.amount2.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 22 - Click the Amount field", testinfo, screenshot);
    });

    await namedStep("Step 23 - Enter Amount", page, testinfo, async () => {
      // Enter Amount
      await createinvoicepayablespage.applyData(dataRow, ["Amount"], 1);
      // Expected: Field captures the entered data.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 23 - Enter Amount", testinfo, screenshot);
    });
    ...
    await namedStep("Step 25 - Click the Office Supplies cell", page, testinfo, async () => {
      // Click the Office Supplies cell
      await createinvoicepayablespage.officeSupplies.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 25 - Click the Office Supplies cell", testinfo, screenshot);
    });

    await namedStep("Step 26 - Click the element element", page, testinfo, async () => {
      // Click the element element
      await createinvoicepayablespage.searchPaymentTerms.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 26 - Click the element element", testinfo, screenshot);
    });

    await namedStep("Step 27 - Click the Immediate cell", page, testinfo, async () => {
      // Click the Immediate cell
      await createinvoicepayablespage.immediate.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 27 - Click the Immediate cell", testinfo, screenshot);
    });

    await namedStep("Step 28 - Click the Invoice Actions link", page, testinfo, async () => {
      // Click the Invoice Actions link
      await createinvoicepayablespage.invoiceActions.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 28 - Click the Invoice Actions link", testinfo, screenshot);
    });

    await namedStep("Step 29 - Click the Validate cell", page, testinfo, async () => {
      // Click the Validate cell
      await createinvoicepayablespage.validate.click();
      // Expected: Element responds as expected.
      const screenshot = await page.screenshot();
      attachScreenshot("Step 29 - Click the Validate cell", testinfo, screenshot);
    });

    await namedStep("Step 30 - Click the Save and Close element", page, testinfo, async () => {
      ...
      const screenshot = await page.screenshot();
      attachScreenshot("Step 30 - Click the Save and Close element", testinfo, screenshot);
    });
